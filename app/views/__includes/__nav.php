<!-- ******** Navbar Top Inicio******** -->
<nav class="main-header navbar navbar-expand navbar-white navbar-light p-0 bgblue_primary inicio" style="height: 20vh;">
  <!-- Left navbar links -->
  <ul class="navbar-nav h-100" style="width: 100%; display: flex; align-items: center;">
    ...
    justify-content: flex-end;">
        <img src="<?= ASSETS ?>/dist/img/LOGO_W.png" alt=""class="w-50">
      </a>
    </li>
...
<!-- ******** Navbar etapas******** -->
<nav class="main-header navbar navbar-expand navbar-white navbar-light p-0 progress_bar d-none" style="height: 20vh;">
  <!-- Left navbar links -->
  <ul class="navbar-nav h-100" style="width: 100%; display: flex; align-items: center;">
    <li class="nav-item h-100" style="    align-items: center;  display: flex;">
      <a class="nav-link h-100"  href="#" style="display: flex;
